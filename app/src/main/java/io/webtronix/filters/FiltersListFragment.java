...
import io.webtronix.filters.utils.BitmapUtils;
...
public class FiltersListFragment extends Fragment implements ThumbnailsAdapter.ThumbnailsAdapterListener {
    ...
    @Override
    public void onFilterSelected(LayoutInflater.Filter filter) {
        if (listener != null)
            listener.onFilterSelected(filter);
    }

    public interface FiltersListFragmentListener {
        void onFilterSelected(LayoutInflater.Filter filter);
    }
}